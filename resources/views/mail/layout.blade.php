                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; width: 100%;">
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        ...
                                        <div style="text-align: center;">
                                            <span class="apple-link" style="text-align: center;"><a href="https://twitter.com/serviceschoolhs" target="blank" style="text-decoration: underline; text-align: center; width: 1.8rem;"><img style="width: 1.5rem;" src="{{ asset('images/twitter.png') }}" alt=""></a></span>
                    
                                            <span class="apple-link" style="text-align: center;"><a href="https://www.instagram.com/serviceschoolhs" target="blank" style="text-decoration: underline; text-align: center; width: 1.8rem;"><img style="width: 1.5rem;" src="{{ asset('images/instagram.png') }}" alt=""></a></span>
                    
                                            <span class="apple-link" style="text-align: center;"><a href="https://www.facebook.com/Service-School-House-103956342056368/" target="blank" style="text-decoration: underline; text-align: center; width: 1.8rem;"><img style="width: 1.5rem;" src="{{ asset('images/facebook.png') }}" alt=""></a></span>
